...
polly = np.array([(w*0.3,h*0.525), (w*0.103,h*0.98), (w*0.92,h*0.98), (w*0.64,h*0.53)], dtype=int)
...
while 1:
    ...
    if frame_counter>total_frames-1 or frame_counter%1000==0:
        cv2.imwrite('road_traffic_4_count.png',color_frame)
