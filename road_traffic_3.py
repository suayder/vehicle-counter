...
line = np.array([(w*0.1,h*0.70),(w*0.89,h*0.70)], dtype=int)
line_2 = np.array([(w*0.156,h*0.65),(w*0.827,h*0.65)], dtype=int)


polly = np.array([(w*0.4,h*0.4), (w*0.02,h*0.818), (w*0.982,h*0.838), (w*0.596,h*0.4)], dtype=int)
...
while 1:
    ...
    bgmask = cv2.morphologyEx(bgmask, cv2.MORPH_DILATE, structuring_element,iterations=2)
    ...
    if frame_counter==total_frames-210 or frame_counter%1000==0:
        cv2.imwrite('road_traffic_3_count.png',color_frame)
